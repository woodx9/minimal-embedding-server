...
def test_qwen3_accuracy():
    ...
    print("\n" + "=" * 60)
    print("使用自定义模型 (MES Engine - Qwen3)")
    print("=" * 60)
    ...
    assert difference < max_tolerance, f"Qwen3模型输出差异过大: 余弦相似度 {sim:.6f}，差异 {difference:.6f} 超过阈值 {max_tolerance}"
    print("Qwen3 精度测试通过!")
